(function(){
  var self, pageMod, notifications, tabs, Request, indexedDB, ref$, setTimeout, clearTimeout, opened_db, get_time_diff, get_newshelper_db, check_recent_seen, get_recent_report, sync_report_data, seen_link, log_browsed_link, check_report;
  self = require('self');
      ...
      return get_recent_report(function(report){
        ...
        return Request({
          ...
          onComplete: function(response){
            ...
            return setTimeout(sync_report_data, 600000);
          }
        }).get();
      });
    });
