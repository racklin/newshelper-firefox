(function(){
  var self, pageMod, notifications, tabs, Request, indexedDB, Widget, Panel, ref$, setTimeout, clearTimeout, opened_db, get_time_diff, get_newshelper_db, check_recent_seen, get_recent_report, sync_report_data, seen_link, log_browsed_link, check_report, newshelperWidgetIcon, newshelperWidgetPageIcon, lastActiveTabResult, newshelperPanel, newshelperWidget;
  self = require('self');
